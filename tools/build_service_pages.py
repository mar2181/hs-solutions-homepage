...
PAGES = {
    "websites-landing-pages.html": dict(
        ...
        hero=("assets/work/ironfield-top.webp", "The Ironfield Peptides storefront home page", "ironfieldpeptides.space, an online store we built and run"),
        ...
        bands=[("An online store with a look of its own", "Ironfield Peptides takes orders for a full catalog, runs a monthly membership and publishes a research guide, on a design built around its brand. Hover the frame to scroll the whole storefront.",
                "assets/work/ironfield-full.webp", "The full Ironfield Peptides storefront home page", "ironfieldpeptides.space"),
